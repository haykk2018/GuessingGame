/*
 * Created by JFormDesigner on Thu Feb 17 01:23:08 AMT 2022
 */

package am.kyureghyan;
...
public class GuessingGame extends JFrame {
    ...
    public void checkGuess() {
        ...
        try {
            ...
            numberOfTries++;
            if (numberOfTries > 8) {
                message = guess + " You lose. You can't guess the number after " + numberOfTries + " tries.";
                newGame();
    ...
    public GuessingGame() {
        ...
        setTitle("Hayk's Hi-Lo Guessing Game");
        getContentPane().setLayout(null);

        JLabel lblDrPaynesHilo = new JLabel("Hayk's Hi-Lo Guessing Game");
